...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_18061 = (0);while(true){
var m_18062 = cljs.core.async.impl.dispatch.tasks.pop();if((m_18062 == null))
{} else
{m_18062.call(null);
if((count_18061 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__18063 = (count_18061 + (1));
count_18061 = G__18063;
continue;
}
} else
{}
