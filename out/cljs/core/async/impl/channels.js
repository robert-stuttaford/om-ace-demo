...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t18067 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t18067 = (function (val,box,meta18068){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t18067.cljs$lang$type = true;
cljs.core.async.impl.channels.t18067.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t18067";
cljs.core.async.impl.channels.t18067.cljs$lang$ctorPrWriter = (function (this__4109__auto__,writer__4110__auto__,opt__4111__auto__){return cljs.core._write.call(null,writer__4110__auto__,"cljs.core.async.impl.channels/t18067");
});
cljs.core.async.impl.channels.t18067.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t18067.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18069){var self__ = this;
var _18069__$1 = this;return self__.meta18068;
});
cljs.core.async.impl.channels.t18067.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18069,meta18068__$1){var self__ = this;
var _18069__$1 = this;return (new cljs.core.async.impl.channels.t18067(self__.val,self__.box,meta18068__$1));
});
cljs.core.async.impl.channels.__GT_t18067 = (function __GT_t18067(val__$1,box__$1,meta18068){return (new cljs.core.async.impl.channels.t18067(val__$1,box__$1,meta18068));
});
}
return (new cljs.core.async.impl.channels.t18067(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_18070 = self__.takes.pop();if((taker_18070 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_18070))
{var take_cb_18071 = cljs.core.async.impl.protocols.commit.call(null,taker_18070);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_18071,taker_18070,this$__$1){
return (function (){return take_cb_18071.call(null,null);
});})(take_cb_18071,taker_18070,this$__$1))
);
} else
{}
{
