...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_17968 = (0);while(true){
if((i_17968 < arr.length))
{(arr[i_17968] = null);
{
var G__17969 = (i_17968 + (1));
i_17968 = G__17969;
continue;
}
} else
...
{var i_17975 = (self__.level + (1));while(true){
if((i_17975 <= (new_level + (1))))
{(update[i_17975] = self__.header);
{
var G__17976 = (i_17975 + (1));
i_17975 = G__17976;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17977 = (0);while(true){
if((i_17977 <= self__.level))
{var links_17978 = (update[i_17977]).forward;if(((links_17978[i_17977]) === x__$1))
{(links_17978[i_17977] = (x__$1.forward[i_17977]));
{
var G__17979 = (i_17977 + (1));
i_17977 = G__17979;
continue;
}
} else
{{
var G__17980 = (i_17977 + (1));
i_17977 = G__17980;
continue;
}
}
