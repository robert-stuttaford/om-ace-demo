...
goog.require('sablono.util');
goog.require('clojure.string');
sablono.interpreter.IInterpreter = (function (){var obj18183 = {};return obj18183;
})();
sablono.interpreter.interpret = (function interpret(this$){if((function (){var and__3530__auto__ = this$;if(and__3530__auto__)
...
{var x__4169__auto__ = (((this$ == null))?null:this$);return (function (){var or__3542__auto__ = (sablono.interpreter.interpret[goog.typeOf(x__4169__auto__)]);if(or__3542__auto__)
{return or__3542__auto__;
} else
{var or__3542__auto____$1 = (sablono.interpreter.interpret["_"]);if(or__3542__auto____$1)
...
*/
sablono.interpreter.element = (function element(element__$1){var vec__18185 = sablono.util.normalize_element.call(null,element__$1);var tag = cljs.core.nth.call(null,vec__18185,(0),null);var attrs = cljs.core.nth.call(null,vec__18185,(1),null);var content = cljs.core.nth.call(null,vec__18185,(2),null);var f = sablono.interpreter.dom_fn.call(null,tag);var js_attrs = sablono.interpreter.attributes.call(null,attrs);if((cljs.core.sequential_QMARK_.call(null,content)) && (cljs.core._EQ_.call(null,(1),cljs.core.count.call(null,content))))
